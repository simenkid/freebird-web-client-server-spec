...
| gad       | 'getProps'     | { id, propNames }        | Get gadget meta-properties. **propNames** is an array of strings and each string is a meta-property name, i.e., given `{ propNames: [ 'description' ] }`.                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| gad       | 'setProps'     | { id, props }            | Set gadget meta-properties. **props** is an object contains meta-properties to set, i.e., given `{ props: { description: 'temperature sensor 3', installed: true } }`.                                                                                                                                                                                                                                                                                                                                                                                                                       |
